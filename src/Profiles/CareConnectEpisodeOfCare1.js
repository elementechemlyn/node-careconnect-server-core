...
let EpisodeOfCare = require(FHIRServer.resources.STU3.EpisodeOfCare)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectEpisodeOfCare1 extends EpisodeOfCare {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-EpisodeOfCare-1'
  }
...
module.exports = CareConnectEpisodeOfCare1
