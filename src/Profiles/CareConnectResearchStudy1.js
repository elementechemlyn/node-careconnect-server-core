...
let ResearchStudy = require(FHIRServer.resources.STU3.ResearchStudy)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectResearchStudy1 extends ResearchStudy {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-ResearchStudy-1'
  }
...
module.exports = CareConnectResearchStudy1
