...
let Slot = require(FHIRServer.resources.STU3.Slot)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectSlot1 extends Slot {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Slot-1'
  }
...
module.exports = CareConnectSlot1
