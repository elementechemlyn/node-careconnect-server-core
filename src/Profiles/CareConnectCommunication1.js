...
let Communication = require(FHIRServer.resources.STU3.Communication)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectCommunication1 extends Communication {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Communication-1'
  }
...
module.exports = CareConnectCommunication1
