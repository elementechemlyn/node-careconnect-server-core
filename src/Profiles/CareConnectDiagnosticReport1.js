...
let DiagnosticReport = require(FHIRServer.resources.STU3.DiagnosticReport)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectDiagnosticReport1 extends DiagnosticReport {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-DiagnosticReport-1'
  }
...
module.exports = CareConnectDiagnosticReport1
