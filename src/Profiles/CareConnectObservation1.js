...
class CareConnectObservation1 extends Observation {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Observation-1'
  }
...
module.exports = CareConnectObservation1
