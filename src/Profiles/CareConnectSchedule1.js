...
let Schedule = require(FHIRServer.resources.STU3.Schedule)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectSchedule1 extends Schedule {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Schedule-1'
  }
...
module.exports = CareConnectSchedule1
