...
let Medication = require(FHIRServer.resources.STU3.Medication)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectMedication1 extends Medication {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Medication-1'
  }
...
module.exports = CareConnectMedication1
