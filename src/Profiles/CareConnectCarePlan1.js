...
let CarePlan = require(FHIRServer.resources.STU3.CarePlan)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectCarePlan1 extends CarePlan {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-CarePlan-1'
  }
...
module.exports = CareConnectCarePlan1
