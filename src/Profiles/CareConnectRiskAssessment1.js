...
let RiskAssessment = require(FHIRServer.resources.STU3.RiskAssessment)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectRiskAssessment1 extends RiskAssessment {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-RiskAssessment-1'
  }
...
module.exports = CareConnectRiskAssessment1
