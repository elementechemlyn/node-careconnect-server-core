...
let Consent = require(FHIRServer.resources.STU3.Consent)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectConsent1 extends Consent {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Consent-1'
  }
...
module.exports = CareConnectConsent1
