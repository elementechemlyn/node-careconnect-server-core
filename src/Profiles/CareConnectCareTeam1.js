...
let CareTeam = require(FHIRServer.resources.STU3.CareTeam)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectCareTeam1 extends CareTeam {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-CareTeam-1'
  }
...
module.exports = CareConnectCareTeam1
