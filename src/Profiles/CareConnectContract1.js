...
let Contract = require(FHIRServer.resources.STU3.Contract)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectContract1 extends Contract {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Contract-1'
  }
...
module.exports = CareConnectContract1
