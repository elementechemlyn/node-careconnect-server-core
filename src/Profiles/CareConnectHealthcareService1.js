...
let HealthcareService = require(FHIRServer.resources.STU3.HealthcareService)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectHealthcareService1 extends HealthcareService {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-HealthcareService-1'
  }
...
module.exports = CareConnectHealthcareService1
