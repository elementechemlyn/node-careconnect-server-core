...
let Observation = require(FHIRServer.resources.STU3.Observation)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectInspiredOxygenObservation1 extends Observation {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-InspiredOxygen-Observation-1'
  }
...
module.exports = CareConnectInspiredOxygenObservation1
