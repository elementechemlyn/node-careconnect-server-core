...
let RelatedPerson = require(FHIRServer.resources.STU3.RelatedPerson)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectRelatedPerson1 extends RelatedPerson {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-RelatedPerson-1'
  }
...
module.exports = CareConnectRelatedPerson1
