...
let DocumentReference = require(FHIRServer.resources.STU3.DocumentReference)
let Meta = require(FHIRServer.resources.STU3.Meta)

class CareConnectDocumentReference1 extends DocumentReference {
  constructor (opt) {
    super(opt)
    if (opt) {
    ...
    this.meta = new Meta()
    this.meta.profile = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-DocumentReference-1'
  }
...
module.exports = CareConnectDocumentReference1
