...
class ExtensionCareConnectMedicationPrescribingAgency1 extends CareConnectBaseExtension {
  constructor (opt) {
    super(opt)
...
module.exports = ExtensionCareConnectMedicationPrescribingAgency1
