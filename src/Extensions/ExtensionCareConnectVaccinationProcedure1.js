...
class ExtensionCareConnectVaccinationProcedure1 extends CareConnectBaseExtension {
  constructor (opt) {
    super(opt)
    opt && delete opt.resourceType
    Object.assign(this, opt)
    this.valueSet = ValueSet
    this.url = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/Extension-CareConnect-VaccinationProcedure-1'
  }
  get codeableConcept () {
    if (this.valueSet){
...
module.exports = ExtensionCareConnectVaccinationProcedure1
