...
class ExtensionCareConnectAnaestheticIssues1 extends CareConnectBaseExtension {
  constructor (opt) {
    super(opt)
    opt && delete opt.resourceType
    Object.assign(this, opt)
    this.valueSet = ValueSet
    this.url = 'https://fhir.hl7.org.uk/STU3/StructureDefinition/Extension-CareConnect-AnaestheticIssues-1'
    this.targetReferences = []
    this.targetReferences.push('https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Condition-1')
  }
...
module.exports = ExtensionCareConnectAnaestheticIssues1
