...
const ExtensionCareConnectEmergencyCareDischargeStatus1 = require('../../../src/Extensions/ExtensionCareConnectEmergencyCareDischargeStatus1.js')

describe('Care Connect Extension ExtensionCareConnectEmergencyCareDischargeStatus1', function () {
  describe('Object constructor', function () {
    it('Can create object', function () {
      let ext = new ExtensionCareConnectEmergencyCareDischargeStatus1()
      expect(ext).toBeInstanceOf(ExtensionCareConnectEmergencyCareDischargeStatus1)
      expect(ext.url).toBe('https://fhir.hl7.org.uk/STU3/StructureDefinition/Extension-CareConnect-EmergencyCareDischargeStatus-1')
    })
  })
