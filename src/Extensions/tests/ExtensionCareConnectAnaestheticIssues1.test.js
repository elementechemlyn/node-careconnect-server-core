...
const ExtensionCareConnectAnaestheticIssues1 = require('../../../src/Extensions/ExtensionCareConnectAnaestheticIssues1.js')

describe('Care Connect Extension ExtensionCareConnectAnaestheticIssues1', function () {
  describe('Object constructor', function () {
    it('Can create object', function () {
      let ext = new ExtensionCareConnectAnaestheticIssues1()
      expect(ext).toBeInstanceOf(ExtensionCareConnectAnaestheticIssues1)
      expect(ext.url).toBe('https://fhir.hl7.org.uk/STU3/StructureDefinition/Extension-CareConnect-AnaestheticIssues-1')
    })
  })
