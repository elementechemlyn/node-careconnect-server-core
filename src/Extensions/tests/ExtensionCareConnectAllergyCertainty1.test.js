...
const ExtensionCareConnectAllergyCertainty1 = require('../../../src/Extensions/ExtensionCareConnectAllergyCertainty1.js')

describe('Care Connect Extension ExtensionCareConnectAllergyCertainty1', function () {
  describe('Object constructor', function () {
    it('Can create object', function () {
      let ext = new ExtensionCareConnectAllergyCertainty1()
      expect(ext).toBeInstanceOf(ExtensionCareConnectAllergyCertainty1)
      expect(ext.url).toBe('https://fhir.hl7.org.uk/STU3/StructureDefinition/Extension-CareConnect-AllergyCertainty-1')
    })
  })
