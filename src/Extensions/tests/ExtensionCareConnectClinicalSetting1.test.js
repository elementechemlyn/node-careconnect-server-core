...
const ExtensionCareConnectClinicalSetting1 = require('../../../src/Extensions/ExtensionCareConnectClinicalSetting1.js')

describe('Care Connect Extension ExtensionCareConnectClinicalSetting1', function () {
  describe('Object constructor', function () {
    it('Can create object', function () {
      let ext = new ExtensionCareConnectClinicalSetting1()
      expect(ext).toBeInstanceOf(ExtensionCareConnectClinicalSetting1)
      expect(ext.url).toBe('https://fhir.hl7.org.uk/STU3/StructureDefinition/Extension-CareConnect-ClinicalSetting-1')
    })
  })
