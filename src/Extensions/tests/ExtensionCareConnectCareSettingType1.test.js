...
const ExtensionCareConnectCareSettingType1 = require('../../../src/Extensions/ExtensionCareConnectCareSettingType1.js')

describe('Care Connect Extension ExtensionCareConnectCareSettingType1', function () {
  describe('Object constructor', function () {
    it('Can create object', function () {
      let ext = new ExtensionCareConnectCareSettingType1()
      expect(ext).toBeInstanceOf(ExtensionCareConnectCareSettingType1)
      expect(ext.url).toBe('https://fhir.hl7.org.uk/STU3/StructureDefinition/Extension-CareConnect-CareSettingType-1')
    })
  })
